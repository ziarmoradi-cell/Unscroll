# Unscroll 1.2 – dein vollständiges Update
...
1. Version ist **1.2**, Build **3**. Wenn Build 3 bereits hochgeladen wurde, bei beiden Targets dieselbe höhere Build-Nummer einstellen.
